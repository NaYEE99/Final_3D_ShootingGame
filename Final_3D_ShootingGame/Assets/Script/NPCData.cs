...
{   // 任務中  光汙染     暗汙染      光祝福  暗祝福 失敗  成功
   Missioning, lPollution, dPollution, lBuff, dBuff, Fail, Finish   // 設定7種資料模式
}
...
{
    [Header("NPC 狀態")]     // NPCState.指定模式(若不加上 = 指定，則預設值為指定第一項)
    public NPCState _NPCState = NPCState.Missioning;
